...
{
    $qty=$_POST["edu-book-4"];
    $cost = $qty*120;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(24,'edu-book-4.jpg','NCO Olympiad Book','".$qty."','".$cost."')";
...
<html>
    ...
    <body>
            <script>
                ...
                function price(x){
                    document.getElementById("cost").innerHTML= x*120;
                }
        ...
        <div class="main-container">
            <div class="Image">
                <img src="edu-book-4.jpg" alt="edu-book-4" title="NCO Olympiad Book">
            </div>
            <div class="info">
                <p id="p1">NCO Olympiad Book</p><br>
                <p id="c">Rs.120</p><br>
                <input id="ip" type="number" placeholder="Qty" name="edu-book-4" 
