...
{
    $qty=$_POST["child-book-2"];
    $cost = $qty*55;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(12,'child-book-2.jpg','Tenali Raman','".$qty."','".$cost."')";
...
<html>
    ...
    <body>
            <script>
                ...
                function price(x){
                    document.getElementById("cost").innerHTML= x*55;
                }
        ...
        <div class="main-container">
            <div class="Image">
                <img src="child-book-2.jpg" alt="child-book-2" title="Tenali Raman">
            </div>
            <div class="info">
                <p id="p1">Tenali Raman</p><br>
                <p id="c">Rs.55</p><br>
                <input id="ip" type="number" placeholder="Qty" name="child-book-2" 
