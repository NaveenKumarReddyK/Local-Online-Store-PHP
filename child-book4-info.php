...
{
    $qty=$_POST["child-book-4"];
    $cost = $qty*80;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(14,'child-book-4.jpg','Enchanted','".$qty."','".$cost."')";
...
<html>
    ...
    <body>
            <script>
                ...
                function price(x){
                    document.getElementById("cost").innerHTML= x*80;
                }
        ...
        <div class="main-container">
            <div class="Image">
                <img src="child-book-4.jpg" alt="child-book-4" title="Enchanted">
            </div>
            <div class="info">
                <p id="p1">Enchanted</p><br>
                <p id="c">Rs.80</p><br>
                <input id="ip" type="number" placeholder="Qty" name="child-book-4" 
