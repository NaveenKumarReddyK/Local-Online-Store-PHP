...
{
    $qty=$_POST["edu-book-3"];
    $cost = $qty*100;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(23,'edu-book-3.jpg','Physics XII','".$qty."','".$cost."')";
...
<html>
    ...
    <body>
            <script>
                ...
                function price(x){
                    document.getElementById("cost").innerHTML= x*100;
                }
        ...
        <div class="main-container">
            <div class="Image">
                <img src="edu-book-3.jpg" alt="edu-book-3" title="CBSE Physics XII">
            </div>
            <div class="info">
                <p id="p1"> CBSE Physics XII</p><br>
                <p id="c">Rs.100</p><br>
                <input id="ip" type="number" placeholder="Qty" name="edu-book-3" 
