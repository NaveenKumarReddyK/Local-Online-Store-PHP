...
{
    $qty=$_POST["edu-book-1"];
    $cost = $qty*60;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(21,'edu-book-1.jpg','Concepts of physics','".$qty."','".$cost."')";
...
?>
<html>
    <title>Concepts Of Physics</title>
    <head>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="Image">
                <img src="edu-book-1.jpg" alt="edu-book-1" title="Concepts of physics">
            </div>
            <div class="info">
                <p id="p1">Concepts of physics</p><br>
                <p id="c">Rs.60</p><br>
                <input id="ip" type="number" placeholder="Qty" name="edu-book-1" 
            ...
            <div >
                    ...
                    <button onclick="close()" id="close" target="_self">X</button>
