...
{
    $qty=$_POST["child-book-3"];
    $cost = $qty*70;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(13,'child-book-3.jpg','Akbar and Birbal','".$qty."','".$cost."')";
...
<html>
    ...
    <body>
            <script>
                ...
                function price(x){
                    document.getElementById("cost").innerHTML= x*70;
                }
        ...
        <div class="main-container">
            <div class="Image">
                <img src="child-book-3.jpg" alt="child-book-3" title="Akbar and Birbal">
            </div>
            <div class="info">
                <p id="p1">Akbar and Birbal</p><br>
                <p id="c">Rs.70</p><br>
                <input id="ip" type="number" placeholder="Qty" name="child-book-3" 
