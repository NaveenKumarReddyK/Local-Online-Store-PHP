...
{
    $qty=$_POST["edu-book-2"];
    $cost = $qty*90;
    try{$sql = "INSERT INTO cart(c_id,c_image,c_name,c_qty,c_price)VALUES(22,'edu-book-2.jpg','Imo Olympiad Book','".$qty."','".$cost."')";
...
<html>
    ...
    <body>
            <script>
                ...
                function price(x){
                    document.getElementById("cost").innerHTML= x*90;
                }
        ...
        <div class="main-container">
            ...
            <div class="info">
                <p id="p1">Imo Olympiad Book</p><br>
                <p id="c">Rs.90</p><br>
